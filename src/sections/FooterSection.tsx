...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/medix_healthcare_me?igsh=MWpzb2dveWs1aXVldg%3D%3D&utm_source=qr",
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@medix.healthcare?_r=1&_t=ZS-96xCQ1R4LWH",
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/share/p/18rrefPpZb/?mibextid=wwXIfr",
  ...
  {
    label: "WhatsApp",
    href: `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? "971585335516"}`,
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className={cn("lg:col-span-1 space-y-6", isRTL && "text-right")}>
            <div className={cn("flex items-center gap-3", isRTL && "flex-row-reverse")}>
              <div className="w-16 h-16 rounded-full overflow-hidden flex-shrink-0 bg-white shadow-lg">
            ...
            <div className="space-y-3">
              ...
              <a href="mailto:info@medixhealthcare.co" className={cn("flex items-center gap-2 text-slate-400 hover:text-sky-400 transition-colors duration-200 text-sm group", isRTL && "flex-row-reverse")}>
                <Mail className="w-4 h-4 text-sky-500 group-hover:scale-110 transition-transform flex-shrink-0" aria-hidden="true" />
                info@medixhealthcare.co
              </a>
