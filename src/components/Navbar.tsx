        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <LangToggle />
              <a href="tel:+971556153629" className={cn("flex items-center gap-2 text-sm font-medium transition-colors duration-300", scrolled ? "text-slate-600 hover:text-sky-600" : "text-white/80 hover:text-white")}>
                <Phone className="w-4 h-4" aria-hidden="true" />
                <span>+971 55 615 3629</span>
              </a>
